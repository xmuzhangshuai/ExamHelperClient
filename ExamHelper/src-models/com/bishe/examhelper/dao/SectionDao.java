...
public class SectionDao extends AbstractDao<Section, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Section_name = new Property(1, String.class, "section_name", false, "SECTION_NAME");
        public final static Property Subject_id = new Property(2, long.class, "subject_id", false, "SUBJECT_ID");
    };

    private DaoSession daoSession;

    private Query<Section> subject_SectionListQuery;
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'SECTION' (" + //
                ...
                "'SECTION_NAME' TEXT NOT NULL ," + // 1: section_name
                "'SUBJECT_ID' INTEGER NOT NULL );"); // 2: subject_id
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Section entity) {
        ...
        stmt.bindString(2, entity.getSection_name());
        stmt.bindLong(3, entity.getSubject_id());
    }
    ...
    public Section readEntity(Cursor cursor, int offset) {
        Section entity = new Section( //
            ...
            cursor.getString(offset + 1), // section_name
            cursor.getLong(offset + 2) // subject_id
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Section entity, int offset) {
        ...
        entity.setSection_name(cursor.getString(offset + 1));
        entity.setSubject_id(cursor.getLong(offset + 2));
     }
    ...
    /** Internal query to resolve the "sectionList" to-many relationship of Subject. */
    public List<Section> _querySubject_SectionList(long subject_id) {
        synchronized (this) {
            if (subject_SectionListQuery == null) {
                QueryBuilder<Section> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.Subject_id.eq(null));
                subject_SectionListQuery = queryBuilder.build();
            }
        }
        Query<Section> query = subject_SectionListQuery.forCurrentThread();
    ...
    protected Section loadCurrentDeep(Cursor cursor, boolean lock) {
        Section entity = loadCurrent(cursor, 0, lock);
    ...
    public Section loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<Section> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<Section> list = new ArrayList<Section>(count);
    ...
    protected List<Section> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<Section> queryDeep(String where, String... selectionArg) {
